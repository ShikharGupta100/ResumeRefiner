  ...
  return (
    <div className="flex flex-col gap-3">
      {Object.entries(SCORE_BREAKDOWN_META).map(([key, meta]) => {
        ...
        return (
          <div key={key} className="rounded-xl bg-[#0a0a0f] border border-[#1e1e2e] flex flex-wrap sm:flex-nowrap items-center gap-3 px-4 py-3">
            <span className="text-slate-200 text-sm w-full sm:w-44 shrink-0">{meta.label}</span>
            <div className="rounded-full bg-[#1e1e2e] flex-1 h-2 min-w-[60px]">
              <div
